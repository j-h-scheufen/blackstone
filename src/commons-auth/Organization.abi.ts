...
export module Organization {
    ...
    export const contract = (client: Provider, address: string) => ({ address, functions: { ERC165_ID_Organization(call = defaultCall): Promise<[
                ...
                departmentId: Buffer;
                userAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["08576BD45480F28CBA07C5DDF514141424B64CE76355D6847109DEF4CA48090B"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogDepartmentUserRemoval()); }, start, end); }, LogDepartmentUserUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                organizationAddress: string;
                departmentId: Buffer;
                userAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["6BB888167384334FDAF5EE77AA1CEC98E9ADEDEEF5DA14D4C1B424D5637E0430"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogDepartmentUserUpdate()); }, start, end); }, LogOrganizationApproverRemoval(callback: (err?: Error, event?: {
                eventId: Buffer;
                __DELETE__: number;
                organizationAddress: string;
                approverAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["2CF132CE6C54465A99F715280CE5C867D610D70C4AC532AD30994DE8F33DFA58"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogOrganizationApproverRemoval()); }, start, end); }, LogOrganizationApproverUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                organizationAddress: string;
                approverAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["2376739F82C5284BDEDEA511CF336C01D8988260CD7A12A37F1AF592E9E695E2"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogOrganizationApproverUpdate()); }, start, end); }, LogOrganizationCreation(callback: (err?: Error, event?: {
                eventId: Buffer;
                organizationAddress: string;
                approverCount: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["4CE3CE68068294254541BE9EA3AFED3606DD2F69EB2193879759452CB8EF56EE"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogOrganizationCreation()); }, start, end); }, LogOrganizationDepartmentRemoval(callback: (err?: Error, event?: {
                eventId: Buffer;
                __DELETE__: number;
                organizationAddress: string;
                departmentId: Buffer;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["E665BA9C1A1DB43EC50A686024B19D956FF6283B84B03450815011382610B872"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogOrganizationDepartmentRemoval()); }, start, end); }, LogOrganizationDepartmentUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                organizationAddress: string;
                departmentId: Buffer;
                userCount: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["4AA55961B303DA16FC3BFD04CB7DFD9CAB19A33C009B69C88F26AED05704AE1E"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogOrganizationDepartmentUpdate()); }, start, end); }, LogOrganizationUserRemoval(callback: (err?: Error, event?: {
                eventId: Buffer;
                __DELETE__: number;
                organizationAddress: string;
                userAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["B217F8AE99B8B240FC28A5281349F7A1D4D460EE3DC7C6D2CA14A57508F704D3"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogOrganizationUserRemoval()); }, start, end); }, LogOrganizationUserUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                organizationAddress: string;
                userAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["B6505E14CF9E15754AFD2220D62DAF87943177C016BD4C031C6EE578E0224226"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogOrganizationUserUpdate()); }, start, end); } } as const, listenerFor: <T extends EventName>(eventNames: T[]): TypedListener<T> => listenerFor(client, address, events, decode, eventNames) as unknown as TypedListener<T>, listener: listenerFor(client, address, events, decode, Object.keys(events) as EventName[]) as TypedListener<EventName> } as const);
