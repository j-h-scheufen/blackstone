...
export module ParticipantsManagerDb {
    ...
    export function deploy(client: Provider, commons_base_ErrorsLib_sol_ErrorsLib: string, commons_collections_MappingsLib_sol_MappingsLib: string, withContractMeta: boolean = false): Promise<string> {
        ...
        return client.deploy(data, withContractMeta ? [{ abi: ParticipantsManagerDb.abi, codeHash: new Keccak(256).update(linker(ParticipantsManagerDb.deployedBytecode, links), "hex").digest("binary") }] : undefined);
    }
