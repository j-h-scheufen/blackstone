...
// TODO: [Silas] Make renewal/expiry a core functionality of all agreements:
//  - Agreements with indefinite term neither renew or expire
//  - All agreements would act as completables (not quite ironed out how to model multiple iterations/recursive relations
//    between a completable and a instance window, may not make sense)
...
contract AbstractRenewable is Renewable {
    ...
    function castRenewalVote(bool _renew) external {
        ...
        ErrorsLib.revertIf(!votes[franchisee].exists,
            ErrorsLib.UNAUTHORIZED(), "AbstractRenewable.castVote()", "The franchisee derived from this caller is not authorized to vote");
