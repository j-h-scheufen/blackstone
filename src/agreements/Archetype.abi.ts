...
export module Archetype {
    ...
    export const contract = (client: Provider, address: string) => ({ address, functions: { ERC165_ID_VERSIONED_ARTIFACT(call = defaultCall): Promise<[
                ...
                archetypeAddress: string;
                active: boolean;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["E4AC67EBCCB90B06B7F90867A2CBAF0E103465CBB9457C569BBF04B46876A8CD"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeActivation()); }, start, end); }, LogArchetypeCreation(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                price: number;
                author: string;
            ...
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["5E1AA3806109E460AD3CF9F44367A1C7B3722DF2A38F7088121F443FD3B0DC7C"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeCreation()); }, start, end); }, LogArchetypeCreation_v1_1_0(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                price: number;
                author: string;
                ...
                formationProcessDefinition: string;
                executionProcessDefinition: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["ADBF13CDB6C80F311F6DD8311F0B575E49E5939DEF1FB02ECD69349BB1116ECE"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeCreation_v1_1_0()); }, start, end); }, LogArchetypeDocumentRemoval(callback: (err?: Error, event?: {
                eventId: Buffer;
                __DELETE__: number;
                archetypeAddress: string;
                documentKey: Buffer;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["A2456C134CC9E5250C388D2650D30D6F21B5529345D0C0DBCB829ECE97670C1A"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeDocumentRemoval()); }, start, end); }, LogArchetypeDocumentUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                documentKey: Buffer;
                documentReference: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["F9EE5F44FF582EA8A3C432AB7C7E81B0C8B158ABB4DD2BDFDD507BBBA85D3DE5"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeDocumentUpdate()); }, start, end); }, LogArchetypeJurisdictionUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                country: Buffer;
                region: Buffer;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["7B43ADFD44FB34CCDA45CB66697BADA72F644D3BA1FE522FBDAAE461DB41B371"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeJurisdictionUpdate()); }, start, end); }, LogArchetypeOwnerUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                owner: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["A89ADDD6BE29302BCF6DFBC1BCE137479D58502C5A88DF66AF0C8D0A30CEA906"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeOwnerUpdate()); }, start, end); }, LogArchetypeParameterUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                parameterName: Buffer;
                parameterType: number;
                position: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["ED6ECB67E04911432D92AE0346B39AC3E380A22A9D6222FC7A5501BF122C6CA0"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeParameterUpdate()); }, start, end); }, LogArchetypePriceUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                price: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["394DCE76AD1D7F179B8F9E11E9CDC3BF972D9BBDB577EDCDC5110FAE56AE9327"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypePriceUpdate()); }, start, end); }, LogArchetypeSuccessorUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                successor: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["0D31ADE3B1C51346CB72ACD198B6D68C4C7DA023E4CE413902926AB3C3E07AC7"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogArchetypeSuccessorUpdate()); }, start, end); }, LogGoverningArchetypeUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                archetypeAddress: string;
                governingArchetypeAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["61347B45AA3A6B34E2C936DE09333C251CA75E2D31E072B401016375F58525CC"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogGoverningArchetypeUpdate()); }, start, end); } } as const, listenerFor: <T extends EventName>(eventNames: T[]): TypedListener<T> => listenerFor(client, address, events, decode, eventNames) as unknown as TypedListener<T>, listener: listenerFor(client, address, events, decode, Object.keys(events) as EventName[]) as TypedListener<EventName> } as const);
