...
export module ActiveAgreement {
    ...
    export const contract = (client: Provider, address: string) => ({ address, functions: { DATA_FIELD_AGREEMENT_CANCELATION_DATE(call = defaultCall): Promise<[
            ...
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["B1F29906146CC7D490B7C500DB434C32BB685A3B4AB06C858A51EB601F134F3E"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogActiveAgreementToPartyCancelationsUpdate()); }, start, end); }, LogActiveAgreementToPartySignaturesUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                party: string;
                signedBy: string;
                signatureTimestamp: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["426746C69DC5D87DB25FF2F3ADE2F69AC26E1C759CF6BE9A11BECEA41E605DDC"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogActiveAgreementToPartySignaturesUpdate()); }, start, end); }, LogAgreementCreation(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
            ...
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["8495C61FFEEE8E374FB2B7169345C2E010B3ABA7EE783414F898879680764F92"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementCreation()); }, start, end); }, LogAgreementCreation_v1_1_0(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                archetypeAddress: string;
                creator: string;
                ...
                legalState: number;
                maxEventCount: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["AF1209150C79D19135C2CBF62BA482AC99586079247AA53C0E25423693DA5D1E"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementCreation_v1_1_0()); }, start, end); }, LogAgreementEventLogReference(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                eventLogFileReference: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["A59F1BDF986536320B730FB73D7D2707EB7B8312A743E1BDC144F0D785572683"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementEventLogReference()); }, start, end); }, LogAgreementLegalStateUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                legalState: number;
                legalStateUpdateTimestamp: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["64B8A7CACD875B7F3D28B9453288CFCC38414B965783E5277C696C655FB4B294"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementLegalStateUpdate()); }, start, end); }, LogAgreementMaxEventCountUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                maxEventCount: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["9D21AB71E7E84FE89B2022FF8E6CC1EAD2CBE7BE8A637907EF2279D4B4D19BB4"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementMaxEventCountUpdate()); }, start, end); }, LogAgreementOwnerUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                owner: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["DC0276B26428605F2E3FB3BFC5BC8F81136E761A84BD0904CB792ECDFBED91C3"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementOwnerUpdate()); }, start, end); }, LogAgreementPrivateParametersReference(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                privateParametersFileReference: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["C9690FEAD6289B57DC690E1C50CD5960BB3EC3D16C01DC445E9059D7C05A27C4"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementPrivateParametersReference()); }, start, end); }, LogAgreementRedaction(callback: (err?: Error, event?: {
                eventId: Buffer;
                __DELETE__: number;
                agreementAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["24B79A501D8660D52A906DDC5071C1494AF214A1443BA687072557C16EF96142"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRedaction()); }, start, end); }, LogAgreementRenewalExpirationDateUpdate(callback: (err?: Error, event?: {
                eventURN: Buffer;
                agreementAddress: string;
                expirationDate: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["065060DDCC74FDB42BD83D60625128B9ACEF117E3FE99B8A50CDFEB0D12B791C"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRenewalExpirationDateUpdate()); }, start, end); }, LogAgreementRenewalFranchiseeUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                franchisee: string;
                voter: string;
                renew: boolean;
                timestamp: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["76C512528B3348A170FCE985B7603A2BA143BDF1E4645153B4D2952E99573E09"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRenewalFranchiseeUpdate()); }, start, end); }, LogAgreementRenewalResultUpdate(callback: (err?: Error, event?: {
                eventURN: Buffer;
                agreementAddress: string;
                renew: boolean;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["B943EFB3FC1DA02BB1E14EED2EE64F5394E1F6F800EE4EA04C80CEFE3A79BC75"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRenewalResultUpdate()); }, start, end); }, LogAgreementRenewalTermsDefined(callback: (err?: Error, event?: {
                eventURN: Buffer;
                agreementAddress: string;
                expirationDate: number;
                threshold: number;
            ...
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["A4607FDD9293C6F4B8B00C658E9537CB8C9962323EFB992B43517D29D462FFF7"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRenewalTermsDefined()); }, start, end); }, LogAgreementRenewalVoteCast(callback: (err?: Error, event?: {
                eventURN: Buffer;
                agreementAddress: string;
                franchisee: string;
                voter: string;
                renew: boolean;
                timestamp: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["51B47958068FC9BEA1ACF9A821D66C2E1BD06EB6261035948B9185300CBCAC5B"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRenewalVoteCast()); }, start, end); }, LogAgreementRenewalWindowClosed(callback: (err?: Error, event?: {
                eventURN: Buffer;
                agreementAddress: string;
                renewalWindowOpen: boolean;
                closedAt: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["D999895EF4E74C2E812B1770FC1D6FB3B5CD235BA2ACB0429F95846E6CA99A6F"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRenewalWindowClosed()); }, start, end); }, LogAgreementRenewalWindowOpened(callback: (err?: Error, event?: {
                eventURN: Buffer;
                agreementAddress: string;
                renewalWindowOpen: boolean;
                openedAt: number;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["38AFD8082DEF1261A99C6531CD2D0F21A60D79BAEC07015B980D61457B752434"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementRenewalWindowOpened()); }, start, end); }, LogAgreementSignatureLogReference(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                signatureLogFileReference: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["4F5146E170CE6C18993979384E01F6A3BF0D482E0C024FF728F019E70A7A024A"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogAgreementSignatureLogReference()); }, start, end); }, LogDataStorageUpdateAddress(callback: (err?: Error, event?: {
                eventId: Buffer;
                ...
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogEntityAddressScopeUpdate()); }, start, end); }, LogGoverningAgreementUpdate(callback: (err?: Error, event?: {
                eventId: Buffer;
                agreementAddress: string;
                governingAgreementAddress: string;
            }) => CancelStreamSignal | void, start?: "first" | "latest" | "stream" | number, end?: "first" | "latest" | "stream" | number): unknown { return client.listen(["E7A1C84892A680B6FB7A2D501B58329E31A92D1AF2CD03E6B97C3E74DEC3DFFD"], address, (err?: Error, event?: Event) => { if (err)
                return callback(err); return callback(undefined, decode(client, event?.log.data, event?.log.topics).LogGoverningAgreementUpdate()); }, start, end); } } as const, listenerFor: <T extends EventName>(eventNames: T[]): TypedListener<T> => listenerFor(client, address, events, decode, eventNames) as unknown as TypedListener<T>, listener: listenerFor(client, address, events, decode, Object.keys(events) as EventName[]) as TypedListener<EventName> } as const);
