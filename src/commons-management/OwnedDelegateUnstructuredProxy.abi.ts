...
export module OwnedDelegateUnstructuredProxy {
    ...
    export function deploy(client: Provider, commons_base_ErrorsLib_sol_ErrorsLib: string, _delegateAddress: string): Promise<string> {
    ...
    export async function deployContract(client: Provider, commons_base_ErrorsLib_sol_ErrorsLib: string, _delegateAddress: string): Promise<Contract> { const address = await deploy(client, commons_base_ErrorsLib_sol_ErrorsLib, _delegateAddress); return contract(client, address); }
